    ...
    return(
      <div onMouseMove={(e) => {manageMouseMove(e)}} className={styles.double}>
        ...
        <div ref={firstImage} className={styles.imageContainer}>
          <a href='https://lbdentalacademy.com/login' className={styles.stretchyWrapper} target="_blank" rel="noopener noreferrer">
            <img 
        ...
        <div ref={secondImage} className={styles.imageContainer}>
          <a href='https://auto-car-git-main-josefzrs-projects.vercel.app' className={styles.stretchyWrapper} target="_blank" rel="noopener noreferrer">
            <img 
